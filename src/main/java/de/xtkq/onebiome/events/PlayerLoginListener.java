package de.xtkq.onebiome.events;
...
public class PlayerLoginListener implements Listener {
    ...
    private String getUpdateMessage() {
        String updateMessage = String.format("&e%s &7v.%s &ris available here: &e%s&r", this.plugin.getName(), UpdateUtils.getLatestRelease(), UpdateUtils.getLatestReleaseURL());
